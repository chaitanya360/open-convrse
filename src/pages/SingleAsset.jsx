  ...
  return (
    <div style={{ display: "flex" }}>
      <CardStyle style={{ minWidth: "500px" }}>
        <h5>Asset {params.id}</h5>
        <img
          src={`${process.env.PUBLIC_URL}/asset${params.id}.png`}
      ...
      <div>
        ...
        <CardStyle style={{ minWidth: "500px", height: "fit-content" }}>
          ...
          <p>
            ...
            doloremque. Accusamus quasi minus accusantium ratione. Lorem ipsum
            dolor sit amet consectetur adipisicing elit. Recusandae accusantium
            facere harum porro alias ad. Sed beatae reiciendis laboriosam at
            dignissimos. Nesciunt voluptate eos perspiciatis velit minima, minus
            quam quasi.
          </p>
        </CardStyle>
      </div>
